...
export function Icon(props: {
  ...
  const paths = {
    inbox: (
      <>
        <path d="M4 4h16l2 8h-5l-2 3H9l-2-3H2l2-8Z" />
        <path d="M4 4 2 12v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-7" />
      </>
    ),
    grid: (
      <>
    ...
    tag: (
      <>
        <path d="M20 13 13 20a2 2 0 0 1-3 0l-7-7V4a1 1 0 0 1 1-1h9l7 7a2 2 0 0 1 0 3Z" />
    ...
    bulb: (
      <>
        <path d="M9 18h6M10 22h4M8.5 15.5A7 7 0 1 1 15.5 15.5c-.8.6-1.2 1.4-1.2 2.5h-4.6c0-1.1-.4-1.9-1.2-2.5Z" />
        <path d="M12 2V0M4.2 4.2 2.8 2.8M19.8 4.2l1.4-1.4" />
      </>
    ),
    monitor: (
      <>
    ...
    book: (
      <>
        <path d="M3 5a4 4 0 0 1 4-2h5v18H7a4 4 0 0 0-4 2ZM21 5a4 4 0 0 0-4-2h-5v18h5a4 4 0 0 1 4 2Z" />
      </>
    ),
    dumbbell: (
      <>
    ...
    plane: (
      <>
        <path d="M22 2 9 15M22 2l-7 20-4-9-9-4Z" />
      </>
    ),
    checkSquare: (
      <>
    ...
    heartPulse: (
      <>
        ...
        <path d="M5 12h4l2-4 2 8 2-4h4" />
      </>
    ),
    leaf: (
      <>
        <path d="M20 4c-9 0-15 4-15 11 0 3 2 5 5 5 7 0 11-7 10-16Z" />
        <path d="M4 22c2-6 7-10 13-13" />
      </>
    ),
    mountain: (
      <>
        <path d="m3 19 6-11 4 7 2-4 6 8Z" />
        <path d="m7.5 11 1.5 1 1.4-1.5" />
      </>
    ),
    search: (
      <>
    ...
    currency: (
      <>
        <path d="M7 7h10M7 11h10M9 4c5 0 6 8 0 8l7 8" />
      </>
    ),
    expense: (
      <>
        <circle cx="12" cy="12" r="9" />
        <path d="M12 7v10m0 0-4-4m4 4 4-4" />
      </>
    ),
    payment: (
      <>
